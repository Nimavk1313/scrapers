...
# --- Configuration ---
URL = "https://www.openvc.app/investor-lists/seed-investors"
OUTPUT_FILENAME = "openvc_seed_investors"

# <<<<<<< INVESTOR LIMIT CONFIGURATION >>>>>>>
# Set the maximum number of investors to collect (0 = no limit)
MAX_INVESTORS = 3512  # Change this to limit investors (e.g., 50, 100, 200)
