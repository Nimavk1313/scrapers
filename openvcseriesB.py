...
# --- Configuration ---
URL = "https://www.openvc.app/investor-lists/series-b-investors"
OUTPUT_FILENAME = "openvc_series_b_investors"

# <<<<<<< INVESTOR LIMIT CONFIGURATION >>>>>>>
# Set the maximum number of investors to collect (0 = no limit)
MAX_INVESTORS = 832  # Change this to limit investors (e.g., 50, 100, 200)
